import pytest
from simpeval.utils.ucca_utils import get_scenes_text, ucca_parse_texts
from simpeval.samsa import sentence_samsa, corpus_samsa
...
def test_sentence_samsa():
    ...
    samsa_score = sentence_samsa(
        orig_sent, sys_sent, lowercase=False, tokenizer="moses"
    )
...
def test_corpus_samsa():
    ...
    samsa_score = corpus_samsa(
        orig_sents, refs_sents[0], lowercase=False, tokenizer="moses"
    )
